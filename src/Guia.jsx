  ...
  return (
    <div>
          ...
          <tbody>
            ...
            <tr>
              <td colSpan={2} className="celda-condiciones">
                La garantía tiene una vigencia de <strong>un (1) mes</strong> a
            ...
            <tr>
              <td colSpan={2} className="celda-condiciones">
                Cubre exclusivamente <strong>fallas de fabricación</strong> o{" "}
                <strong>defectos en los componentes internos</strong> del
                letrero iLED PRO.
              </td>
            </tr>
            ...
            <tr>
              <td colSpan={2} className="celda-condiciones">
                ...
                <ul>
                  <li>
                    Manipulación, apertura o modificación del letrero por
                    personal no autorizado.
                  </li>
                  <li>
                    Daños por sobrecarga eléctrica, cortocircuito o instalación
                    incorrecta.
                  </li>
                  <li>
                    Uso de fusible distinto al especificado (debe ser de{" "}
                    <strong>5 amperios</strong>).
                  </li>
                  <li>
                    Golpes, caídas, quemaduras o cualquier daño físico evidente.
                  </li>
                  <li>
                    Uso inadecuado o en ambientes no recomendados (humedad,
                    calor excesivo, exposición al agua).
                  </li>
                </ul>
              </td>
            </tr>
            ...
            <tr>
              <td colSpan={2} className="celda-condiciones">
                El cliente deberá presentar el letrero junto con el{" "}
                <strong>comprobante de compra</strong>. Si el producto tiene una
                falla cubierta por la garantía y{" "}
                <strong>hay unidades en existencia</strong>, se entregará un
                reemplazo inmediato. Mientras tanto, el letrero original será
                enviado al fabricante para evaluación.{" "}
                <strong>El cliente no asumirá costos</strong> de envío o
                devolución, estos serán cubiertos por el proveedor.
              </td>
            </tr>
            ...
            <tr>
              <td colSpan={2} className="celda-condiciones">
                Una vez vencido el periodo de garantía, cualquier reparación
                estará sujeta a evaluación técnica.{" "}
                <strong>
                  Los costos de reparación, repuestos y gastos de envío
                </strong>{" "}
                (ida y vuelta por paquetería) deberán ser cubiertos por el
                cliente.
              </td>
            </tr>
            ...
            <tr>
              <td colSpan={2} className="celda-condiciones">
                Se recomienda seguir al pie de la letra las indicaciones del
                videotutorial entregado. Una instalación adecuada garantiza un
      ...
      <button
        className="boton-capturar-simbolos"
        onClick={() =>
          capturarTabla(tablaterminosRef.current, "Tabla Terminos")
        }
      >
      ...
      <p className="direccion-web-guia">
      ...
      <div className="imagen-guia">
        <img
          src={`${import.meta.env.BASE_URL}guia/botones_app.png`}
          alt={"Guia botones app"}
        />
      </div>
      <br></br>
      <br></br>
      ...
      <div>
        <table className="tabla-gifs" ref={tablaGifsRef}>
          ...
          <tbody>
            ...
            <tr>
              <td className="terminos" colSpan={2}>
                Asegúrate de que tu letrero sea versión 4.0 o superior y de
                conocer la resolución de tu letrero en LEDs. Ejemplo: 64x16,
                128x32, 64x32, etc.
              </td>
            </tr>
